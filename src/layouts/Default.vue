<template>
  <div class="w-full">
    ...
    <slot />
    <footer class="w-full bg-gray text-white pt-9">
      <div class="container">
        <div class="w-full flex flex-col md:flex-row justify-start md:justify-between text-left pb-11 border-b border-gray-light">
          <div class="w-full md:w-8/12 flex flex-col justify-start">
            <g-image :src="'/uploads/logo-icon.svg'" class="mb-8 w-[80px] ml-0" />
            <h4 class="text-38 leading-[48px] tracking-[-0.76px] max-w-[415px]">
              Empowering
              <strong class="text-lime font-light">innovative</strong> and ethical data teams
            </h4>
          </div>
          <div class="w-full md:w-4/12 flex flex-col justify-start md:flex-row md:items-end mt-8 md:mt-auto">
            <ul class="grid grid-cols-2 gap-x-8 text-left">
              <li class="flex justify-start">
                <g-link :to="'/'" class="text-17 leading-tight tracking-normal py-2 text-left">Home</g-link>
              </li>
              <li class="flex justify-start">
                <g-link :to="'/about'" class="text-17 leading-tight tracking-normal py-2 text-left">About</g-link>
              </li>
              <li class="flex justify-start">
                <g-link :to="'/careers'" class="text-17 leading-tight tracking-normal py-2 text-left">Careers</g-link>
              </li>
              <li class="flex justify-start">
                <g-link :to="'/pricing'" class="text-17 leading-tight tracking-normal py-2 text-left">Pricing</g-link>
              </li>
              <li class="flex justify-start">
                <g-link :to="'/product'" class="text-17 leading-tight tracking-normal py-2 text-left">Product</g-link>
              </li>
            </ul>
            <ul class="flex ml-0 mt-8 md:mt-auto md:ml-14">
              <li class="flex">
