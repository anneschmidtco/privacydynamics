<template>
  <div class="w-full flex flex-col px-4 md:px-8 pt-8 md:pt-14 pb-14 md:pb-20 bg-gray-lighter items-start">
    ...
    <div class="mb-10 md:mb-12 md:min-h-[180px]">
      <h3 class="text-32 md:text-[45px] leading-45 md:leading-60 font-normal tracking-[-0.96px] md:tracking-[-1px] break-words" v-animate.repeat="'fade-in-down'">{{ feature.title }}</h3>
    </div>
