<template>
  <div class="w-full hero">
    <div class="container max-w-screen-xl flex items-center py-44">
          <div class="w-full md:w-7/12 pr-0 md:pr-6">
            <div class="text-[65px] font-light text-brand-gray leading-[75px] tracking-[-1.3px]" v-html="header(hero_section.header)"></div>
          ...
          <div class="w-full md:w-5/12 pl-0 md:pl-8">
