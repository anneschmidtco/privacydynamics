<template>
  <div class="w-full">
    <g-link v-if="link && !isButton" :to="link">
      <span class="btn inline-flex items-center justify-center group px-8 py-4 mx-1 text-15 font-display font-medium text-gray text-center bg-lime w-auto hover:bg-gray hover:text-white cursor-pointer hover:fill-lime transition-colors duration-1000" :class="isFullWidth ? 'w-full' : ''" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
    ...
    <button v-if="isButton" @click="onClick" class="btn appearance-none inline-flex items-center justify-center px-8 py-4 mx-1 text-15 font-display font-medium text-gray text-center bg-lime w-auto hover:bg-gray hover:text-lime cursor-pointer hover:fill-lime" :class="isFullWidth ? 'w-full' : ''" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
      <span v-if="icon">
