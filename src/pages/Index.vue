<template>
  <Layout>
    ...
    <div class="w-full bg-gray-lighter py-14 md:py-0 border-b border-gray-border md:border-none">
      <div class="container flex flex-col md:flex-row px-0">
        <div class="w-full md:w-1/3 feature-item" :class="index < 2 ? 'border-b border-gray-border' : ''" v-for="(feature, index) in $page.pages.features" :key="index">
    ...
    <div class="w-full bg-gray pt-14 pb-14 md:pt-[106px] md:pb-14 text-white overflow-hidden">
      <div class="container">
        <div class="w-full flex flex-col md:flex-row items-center justify-between py-11 px-8 md:px-[109px] bg-gray-light rounded-2xl md:rounded-[20px]">
          <div class="flex flex-row items-center">
            ...
            <div class="title-has-highlight text-center md:text-left text-4xl md:text-50 leading-[36px] tracking-[-1.5px] md:ml-12" v-animate.repeat="'fade-in'" v-html="parseMarkdown($page.pages.in_action_section.title)"></div>
          </div>
