  ...
  <Layout>
          ...
          <div class="w-full flex justify-between items-center">
            ...
            <div>
              <svg
                ...
                width="26.789"
                height="26.79"
                viewBox="0 0 26.789 26.79"
              >
                <g
                  id="Group_77"
                  data-name="Group 77"
                  transform="translate(34.354 8.516) rotate(135)"
                >
                  <path
                    id="Path_2"
                    data-name="Path 2"
                    d="M175.539,443.179l-.95-.95,10.421-10.421L174.59,421.388l.95-.95,11.37,11.37Z"
                    transform="translate(-161.067 -420.438)"
                    fill="#ccf74f"
                  />
                  <rect
                    id="Rectangle_5"
    ...
    >
      ...
      >
        ...
        >
          <div class="w-full flex justify-between items-center">
            <h2
              class="text-brand-gray font-display text-[14px] tracking-[2.1px]"
            >
            ...
            <ul class="list-none">
              <li
                class="
                  ...
                  cursor-pointer
                "
                v-for="(value, index) in $page.pages.values_section.values"
                :key="index"
                :class="isActive(index) ? 'active' : ''"
                @click.capture="activate(index)"
              >
                <hr
                  class="
                    w-[59px]
                  ...
                  "
                />
                <span class="font-inherit transition-all">{{
                  value.title
                }}</span>
              </li>
            </ul>
        ...
        <div
          class="
            ...
            py-14
            px-4
            md:px-0 md:pt-32 md:pl-12 md:pb-14
            flex flex-col
          "
        >
    ...
    <div
      class="
        ...
        from-white
        to-brand-gray-fade
        border-b border-brand-gray-lighter
      "
    >
      <div class="container">
        <div class="w-full flex flex-col md:flex-row md:items-stretch relative">
          ...
          >
            <div class="w-full flex justify-end">
              ...
              >
                ...
                <g
                  id="Group_81"
                  data-name="Group 81"
                  transform="translate(99.504 99.504) rotate(180)"
                >
                  <g
                    id="Group_80"
                    data-name="Group 80"
                  ...
                  >
                    <path
                      id="Path_87"
                      data-name="Path 87"
                      d="M49.752,99.5A49.752,49.752,0,1,1,99.5,49.752,49.808,49.808,0,0,1,49.752,99.5m0-98.068A48.316,48.316,0,1,0,98.068,49.752,48.372,48.372,0,0,0,49.752,1.436"
                      fill="#454f59"
                    />
                    <path
                      id="Path_88"
                      data-name="Path 88"
                      d="M73.19,69.074H71.419V49.642H51.988V47.871h21.2Z"
                      transform="translate(-11.381 -10.48)"
                      fill="#454f59"
                    />
                    <rect
                      id="Rectangle_453"
                      ...
                      width="32.822"
                      height="1.772"
                      transform="matrix(0.706, -0.708, 0.708, 0.706, 37.099, 60.871)"
                      fill="#454f59"
                    />
                  </g>
                </g>
            ...
            <div class="w-full mt-12 flex flex-wrap md:max-w-[400px]">
              <span
                v-for="(tag, index) in tags($page.pages.team_section.tags)"
                :key="index"
                class="
                  lowercase
                  text-[17px]
        ...
        <div class="w-full flex flex-col md:flex-row md:items-stretch">
          ...
          >
            <div
              class="flex flex-col"
              v-for="(leader, index) in $page.pages.leaders_section.leaders"
              :key="index"
            >
        ...
        <div class="w-full flex flex-col md:flex-row md:items-stretch">
          ...
          >
            <div class="w-full grid grid-cols-3 gap-3 gap-y-5">
              <div
                class=""
                v-for="(comp, index) in $page.pages.investors_section.investors"
                :key="index"
              >
            ...
            <div class="w-full grid grid-cols-5 gap-3">
              <div
                class=""
                v-for="(comp, index) in $page.pages.investors_section
                  .other_investors"
                :key="index"
              >
                <g-image :src="comp.logo" />
    ...
    <div class="container">
      ...
      >
        ...
        <div class="w-full md:w-8/12 flex flex-col">
          <div
            class="w-full flex flex-col py-9 border-b border-brand-gray-light"
            v-for="(item, index) in $page.pages.media_section.press_releases"
            :key="index"
          >
            <div class="w-full flex justify-between items-center mb-5">
              ...
              <span
                class="text-[15px] leading-[28px] tracking-[1.5px] font-display"
                >{{ parseDate(item.date) }}</span
              >
            </div>
            <div class="w-full">
              ...
              <a
                class="text-[15px] leading-[28px] tracking-[-0.3px] underline"
                :to="item.link"
                >Read More</a
              >
            </div>
            ...
            <div class="w-full flex flex-col">
              ...
              <a
                class="
                  ...
                  uppercase
                "
                :to="'mailto:' + $page.pages.media_section.contact.email"
                >{{ $page.pages.media_section.contact.email }}</a
              >
            </div>
          </div>
        </div>
        ...
        >
          <div
            class="
              ...
              mb-3
            "
            v-html="parse_markdown($page.pages.cta_section.header)"
          ></div>
          <div
            class="text-[35px] leading-[33px] tracking-[-0.7px]"
            v-html="parse_markdown($page.pages.cta_section.sub_header)"
          ></div>
        </div>
      </div>
    </div>
